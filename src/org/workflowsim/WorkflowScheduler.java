...
import org.workflowsim.scheduling.PowerAwareFuzzyMaxMaxSchedulingAlgorithm;
import org.workflowsim.scheduling.PowerAwareFuzzyMinMaxSchedulingAlgorithm;
import org.workflowsim.scheduling.PowerAwareFuzzySeqSchedulingAlgorithm;
import org.workflowsim.scheduling.PowerAwareMaxMinSchedulingAlgorithm;
import org.workflowsim.scheduling.PowerAwareMinMinSchedulingAlgorithm;
import org.workflowsim.scheduling.PowerAwareMinPowerSchedulingAlgorithm;
import org.workflowsim.scheduling.PowerAwareSeqSchedulingAlgorithm;
    ...
    private BaseSchedulingAlgorithm getScheduler(SchedulingAlgorithm name) {
        ...
        switch (name) {
            ...
            case ROUNDROBIN:
                ...
                break;
            case POWERSEQ:
            	algorithm = new PowerAwareSeqSchedulingAlgorithm();
            	break;
            case POWERMINMIN:
            	algorithm = new PowerAwareMinMinSchedulingAlgorithm();
            	break;
            case POWERMIN:
            	algorithm = new PowerAwareMinPowerSchedulingAlgorithm();
            	break;            	
            case POWERMAXMIN:
            	algorithm = new PowerAwareMaxMinSchedulingAlgorithm();
            	break;
            case POWERFUZZYSEQ:
            	algorithm = new PowerAwareFuzzySeqSchedulingAlgorithm();
            	break;
            case POWERFUZZYMINMAX:
            	algorithm = new PowerAwareFuzzyMinMaxSchedulingAlgorithm();
            	break;
            case POWERFUZZYMAXMAX:
            	algorithm = new PowerAwareFuzzyMaxMaxSchedulingAlgorithm();
            	break;
            default:
                algorithm = new StaticSchedulingAlgorithm();
                break;
