...
public class PowerAwareFuzzyMaxMaxSchedulingAlgorithm extends BaseSchedulingAlgorithm
{
	public PowerAwareFuzzyMaxMaxSchedulingAlgorithm()
	{
        super();
    }
    ...
    public void run()
    {
        ...
        for (int c = 0; c < cloudletSize; c++)
        {
        	...
        	for (int v = 0; v < vmSize; v++)
        	{
        		...
        		{
        			fuzzySelection = getFuzzySelection(maxCloudlet, vm);
