...
public class PowerAwareFuzzySeqSchedulingAlgorithm extends BaseSchedulingAlgorithm
{
	
	public PowerAwareFuzzySeqSchedulingAlgorithm()
	{
        super();
    }
	...
	public void run()
	{
        ...
        for (int c = 0; c < cloudletSize; c++)
        {
        	...
        	for (int v = 0; v < vmSize; v++)
        	{
        		...
        		{
        			fuzzySelection = getFuzzySelection(cloudlet, vm);
